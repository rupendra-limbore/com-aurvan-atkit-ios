...
public class ATProgressOverlay: NSObject {
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared
     ```
     */
    public static let shared :ATProgressOverlay = ATProgressOverlay()
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.shouldBlurBackground = true
     ```
     */
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.backgroundColor = UIColor(red: 135.0/255.0, green: 206.0/255.0, blue: 250.0/255.0, alpha: 0.5)
     ```
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.activityIndicatorViewStyle = UIActivityIndicatorViewStyle.whiteLarge
     ```
     */
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.isActivityIndicatorHidden = true
     ```
     */
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.message = "Loading your request, please wait until response is received from the server."
     ```
     */
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.messageColor = UIColor.orange
     ```
     */
    ...
    private let defaultBackgroundColor :UIColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.5)
     ...
     **Usage Example**
     ```swift
     ATProgressOverlay.shared.show() // Does not show network activity indicator on status bar.
     
     ATProgressOverlay.shared.show(isNetworkActivity: true) // Shows network activity indicator on status bar.
     ```
    ...
    public func show(isNetworkActivity pIsNetworkActivity :Bool = false) {
        ...
        if self.shouldBlurBackground == true {
            self.backgroundView = UIVisualEffectView(effect: UIBlurEffect(style: UIBlurEffect.Style.dark))
        } else {
     ...
     **Usage Example**
     ```swift
     // Scenario 1
     ATProgressOverlay.shared.show()
     ATProgressOverlay.shared.hide()
     ATProgressOverlay.shared.show()
     ATProgressOverlay.shared.hide()
     ...
     ATProgressOverlay.shared.show()
     ATProgressOverlay.shared.show()
     ATProgressOverlay.shared.hide(force: true)
