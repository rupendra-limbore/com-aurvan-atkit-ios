...
final class ATKitTests: XCTestCase {
    ...
    func testRsaSignature() {
        do {
            ...
            var aSignature = try ATEncryptionManager.generateRsaSignature(string: aPlainText, privateKey: aPrivateKey1024, encoding: .base64)
            ...
            aSignature = try ATEncryptionManager.generateRsaSignature(string: aPlainText, privateKey: aPrivateKey1024, encoding: .hex)
            ...
            aSignature = try ATEncryptionManager.generateRsaSignature(string: aPlainText, privateKey: aPrivateKey2048, encoding: .base64)
            ...
            aSignature = try ATEncryptionManager.generateRsaSignature(string: aPlainText, privateKey: aPrivateKey2048, encoding: .hex)
